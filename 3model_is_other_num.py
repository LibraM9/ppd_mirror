...
for i in range(32):
    ...
    feature_importance.to_csv(outpath+"importance_is_{}.csv".format(i))
    #测试集逾期概率
    test_dic = {
    ...
    test_prob.to_csv(outpath+"is_{}_0614.csv".format(i),index=None)
    model_n.append(i)
...
model_loss.to_csv(outpath+"auc_model1_31.csv")
